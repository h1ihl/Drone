...
para('The selected frame concept is a modular-arm design (Concept C of three compared), chosen for repairability during iterative testing. The propulsion system is a real, sourced 2S brushless setup (1103 11000KV motors, 65mm props, an AIO flight controller/ESC board) running Betaflight - no custom flight-stabilization firmware. A servo-actuated latch mechanism (SG90) delivers a 20-100 g payload.');
...
para('Real, verified component pricing pushes the fully-capable build (meeting the stated 100-300 g mass / 20-100 g payload target) to approximately $155 CAD, above the original $100 CAD target - this is presented honestly as a real market constraint, not hidden. The user has indicated some willingness to stretch the budget; a cheaper brushed-motor fallback (~$125 CAD) is also documented, at reduced payload capacity.');
