...
const rows = [
  ...
  ['RC link', 'ESP32-C3 Super Mini (onboard RX)', 1, 'RISC-V, 2.4GHz WiFi, custom firmware: ESP-NOW RX -> SBUS out (inverted UART) to FC', {usd:3.99}, 'AliExpress', 'https://www.aliexpress.com/item/1005005319963906.html', 'No', 'Yes', 'Recommended', 'Purchased', 'Estimated - real AliExpress listings found this session, $3.50-4.80 USD range'],
  ['RC link', 'ESP32-WROOM-32 DevKit (handheld TX) + KY-023 dual-axis joystick x2 + momentary/toggle switch x2', 1, 'Dual-core, 2.4GHz WiFi, custom firmware: reads sticks/switches -> ESP-NOW out. 4 stick axes (throttle, yaw, pitch, roll) + 2 AUX switches (arm, payload release). Powered via USB power bank, already owned, not priced separately.', {usd:4.40}, 'AliExpress (DevKit $2.20 + 2x joystick $0.60 + 2x switch ~$0.50 est.)', 'https://www.aliexpress.com/item/1005003145871431.html ; https://www.aliexpress.com/item/1882818018.html', 'No', 'Yes', 'Recommended', 'Purchased', 'Estimated - DevKit and joystick prices from real AliExpress listings found this session; switch price is a typical-component estimate, no specific listing checked'],
  ['Motors', '1103 11000KV brushless motor (4-pack)', 1, '~3.3-3.55g each, 2S-rated, 1.5mm shaft, price is for the full set of 4', {usd:50.99}, 'Pyrodrone (BetaFPV)', 'https://pyrodrone.com/products/betafpv-1103-11000kv-2s-brushless-motor-4pcs', 'No', 'Yes', 'Recommended', 'Purchased', 'Manufacturer-specified'],
  ...
  ['Motors (Minimum tier alt.)', 'Coreless brushed motor 8520 (4pcs + props)', 1, '8.5x20mm, ~53000rpm, 3.7-7.4V', {usd:9.00}, 'AliExpress/Amazon', 'https://www.aliexpress.com/item/32823056468.html', 'No', 'Alt.', 'Minimum', 'Purchased', 'Estimated (fetch failed, price not independently confirmed)'],
  ...
  ['Spare/replacement', 'Spare motor set (4x 1103 11000KV)', 1, 'Crash spares', {usd:50.99}, 'Pyrodrone', 'https://pyrodrone.com/products/betafpv-1103-11000kv-2s-brushless-motor-4pcs', 'No', 'No', 'Maximum', 'Purchased', 'Manufacturer-specified'],
